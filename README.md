...
3. Download and install the [Google Contacts JDBC Driver from CData](https://www.cdata.com/drivers/googlecontacts/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
